...
export const MAX_FILES_PER_AUTHORIZE_BATCH = 32;
export const MAX_FILES_PER_FINALIZE_BATCH = 32;
...
export const MAX_BATCH_AUTHORIZED_FILES_PER_MINUTE = 960;
export const PUT_CONCURRENCY_MIN = 4;
export const PUT_CONCURRENCY_MAX = 8;
export const PUT_CONCURRENCY_DEFAULT = 6;
export const AUTHORIZE_BATCH_SIZE = 32;
export const FINALIZE_BATCH_SIZE = 32;
